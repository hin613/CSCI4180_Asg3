...
public class MyDedup {
  ...
  public static void upload(int minChunk, int avgChunk, int maxChunk, int d, String fileToUpload, String storageType){
  ...
  public static void download(String fileToDownload, String storageType) {
      ...
      switch (storageType) {
          case "local":
              ...
              break;
          default:
              System.err.println("Unresolved storage type");
      }

  }

  public static void delete(String fileToDelete, String storageType) {
      switch (storageType) {
          case "local":
              try {
                  FileRecipeList FileRecipeList = new FileRecipeList();
                  ...
                  for (String sha1Hex : recipeList) {
                      ...
                      if (IndexList.index.get(sha1Hex).refCount == 0) {
                          ...
                          File file = new File(dir.getName() + "/" + sha1Hex);
                          file.delete();
      ...
      case "upload":
        if (args.length != 7) {
          ...
          if (!(storageType.equals("local") || storageType.equals("azure"))) {
            ...
            upload(minChunk, avgChunk, maxChunk, d, fileToProcess, storageType);
          }
        }
        break;
        case "download":
          if (args.length != 3) {
            ...
            if (!(storageType.equals("local") || storageType.equals("azure"))) {
              ...
              download(fileToProcess, storageType);
            }
          }
          break;
          case "delete":
            if (args.length != 3) {
              ...
              if (!(storageType.equals("local") || storageType.equals("azure"))) {
                ...
                delete(fileToProcess, storageType);
              }
            }
            break;
            default:
